...
type InventoryTransaction struct {
	...
	BarcodeStickerID *uint                 `gorm:"index;constraint:OnUpdate:CASCADE,OnDelete:SET NULL;"`
	BarcodeSticker   *BarcodeSticker       `gorm:"foreignKey:BarcodeStickerID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:SET NULL;"`
